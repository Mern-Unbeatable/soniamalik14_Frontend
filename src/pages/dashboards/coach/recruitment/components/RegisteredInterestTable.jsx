    ...
    return (
        <div className="w-full bg-white rounded-xl border border-gray-200 shadow-md font-sans overflow-hidden">
            ...
            <div className="pt-6 px-6 pb-4">
                <h2 className="m-0 text-2xl font-semibold text-gray-900">Registered Interest</h2>
            </div>
            ...
            <div className="block md:hidden px-4 pb-2">
                {currentItems.length > 0 ? (
                    ...
                    <div className="py-6 text-center text-base text-gray-500">No registered interests found.</div>
                )}
            </div>
