...
import { Medal, Calendar, Users, Link2 } from 'lucide-react';
                ...
                {item.bookingLink ? (
                    <div className="flex items-center gap-4 bg-white p-3.5 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div className="min-w-0">
                            <p className="text-base text-[#101828] font-medium mb-0.5">Website link</p>
                            <a
                                href={item.bookingLink}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-base text-[#0F766E] hover:underline break-all"
                            >
                                {item.bookingLink}
                            </a>
                        </div>
